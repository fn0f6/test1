...
const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-[90vh] md:min-h-[95vh] flex items-center pt-24 overflow-hidden">
      {/* تم إزالة الخلفية المنفصلة من هنا لأنها أصبحت خلفية للموقع بالكامل في App.tsx */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="space-y-8 md:space-y-10 text-center lg:text-left">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-display font-black text-white leading-[1.1] md:leading-[0.95] tracking-tighter opacity-0 animate-fade-in-up delay-100 drop-shadow-2xl">
          ...
          <p className="text-base md:text-lg lg:text-xl text-slate-200 max-w-lg mx-auto lg:mx-0 leading-relaxed font-bold opacity-0 animate-fade-in-up delay-200 drop-shadow-lg">
            {subheadline}
          </p>
